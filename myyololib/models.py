...
class QYOLOv8n(nn.Module):
    def __init__(self, ch=3, nc=80, model_qcfg: dict = {}):
        super().__init__()
        if model_qcfg is None:
            model_qcfg = {}
        self.model = nn.Sequential(
            QConv(ch, 16, 3, 2, qcfg=model_qcfg.get("layer_0")),            # 0
            QConv(16, 32, 3, 2, qcfg=model_qcfg.get("layer_1")),            # 1
            QC2f(32, 32, 1, True, layer_qcfg=model_qcfg.get("layer_2")),    # 2
            QConv(32, 64, 3, 2, qcfg=model_qcfg.get("layer_3")),            # 3
            QC2f(64, 64, 2, True, layer_qcfg=model_qcfg.get("layer_4")),    # 4
            QConv(64, 128, 3, 2, qcfg=model_qcfg.get("layer_5")),           # 5
            QC2f(128, 128, 2, True, layer_qcfg=model_qcfg.get("layer_6")),  # 6
            QConv(128, 256, 3, 2, qcfg=model_qcfg.get("layer_7")),          # 7
            QC2f(256, 256, 1, True, layer_qcfg=model_qcfg.get("layer_8")),  # 8
            QSPPF(256, 256, 5, layer_qcfg=model_qcfg.get("layer_9")),       # 9
            nn.Upsample(scale_factor=2, mode='nearest'),                    # 10
            Concat(dimension=1),                                            # 11
            QC2f(384, 128, 1, False, layer_qcfg=model_qcfg.get("layer_12")),# 12
            nn.Upsample(scale_factor=2, mode='nearest'),                    # 13
            Concat(dimension=1),                                            # 14
            QC2f(192, 64, 1, False, layer_qcfg=model_qcfg.get("layer_15")), # 15
            QConv(64, 64, 3, 2, qcfg=model_qcfg.get("layer_16")),           # 16
            Concat(dimension=1),                                            # 17
            QC2f(192, 128, 1, False, layer_qcfg=model_qcfg.get("layer_18")),# 18
            QConv(128, 128, 3, 2, qcfg=model_qcfg.get("layer_19")),         # 19
            Concat(dimension=1),                                            # 20
            QC2f(384, 256, 1, False, layer_qcfg=model_qcfg.get("layer_21")),# 21
            QDetect((64, 128, 256), layer_qcfg=model_qcfg.get("layer_22"))  # 22, [P3, P4, P5] 
        )
